function parameters =  params4SensiAna_YJM()
		...
		% temp_.omega_P = 2.4;
		temp_.omega_R = [4.5, 5.0, 5.5];
		temp_.omega_P = [3.0, 3.5, 4.0];
		

		% how quickly income decreases with large temperature deviations
		temp_.k_R = [3.0, 3.5, 4.0];
		temp_.k_P = [1.5, 2.0, 2.5];
		temp_.c_R = [2.5, 3.0, 3.5];
		temp_.c_P = [2.0, 2.5, 3.0];
		% temp_.k_R = 0.5; 
		% temp_.c_R = 3.0;
		% temp_.k_P = 1.0;
		% temp_.c_P = 2.0;

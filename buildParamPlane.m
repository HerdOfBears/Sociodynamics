function simResults = buildParamPlane(param1, param1_L, param1_H, param2, param2_L, param2_H, dt, temp_proj, delta_val, homophilyVal)
	...
	for param1_newVal = param1_L:(dt):param1_H
		for param2_newVal = param2_L:(dt):param2_H
			...
			parameters_given.('t_f')  = temp_proj;
			parameters_given.('delta') = delta_val;
			parameters_given.("homophily") = homophilyVal;
	...
	allResults.("deltaVal") = delta_val;
	allResults.("temp_f") = temp_proj;
	allResults.('homophily') = homophilyVal;

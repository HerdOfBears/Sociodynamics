function parameters_ = get_parameters(random_yes_no)
    ...
    if ~random_yes_no
        ...
        tao_co2 = 1.73.*(mixingCO2a(0, C_at0, f_gtm, k_a)).^0.263;
        H = calibrate_humidity(P_0, latent_heat, A, S, tao_CH4, tao_co2);
        ...
        % 21
        pdA = makedist('Triangular', 'a', 0.2025, 'b', 0.225, 'c', 0.2475);
        %A = 0.225;
        ...
        t_f   = 50;%random(pdt_f, 1,1); % (0, 25, 50) num yrs ahead for temp. proj.
